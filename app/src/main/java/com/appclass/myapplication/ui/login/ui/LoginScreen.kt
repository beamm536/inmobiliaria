...
fun PasswordField(password: String, onTextFieldChanged: (String) -> Unit) {
    TextField(
        ...
        textStyle = LocalTextStyle.current.copy(color = Color(0xFF636262)) //con esto sustituyo el textColor q me estaba dando error
    )
}
...
fun HeaderImage(modifier: Modifier) {
    Image(
        painter = painterResource(id = R.drawable.logo_web_nebrija_fp), //cambiar esta imagen por el logo de la inmobiliaria
